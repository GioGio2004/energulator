  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="glass-panel-light rounded-3xl p-6 shadow-sm">
        <h3 className="text-sm font-bold uppercase tracking-wider text-gray-400 mb-4 text-center">Your Progress</h3>
        ...
        {gameStatus === undefined ? (
          ...
          <p className="text-center text-gray-500 text-sm">No progress data recorded yet.</p>
        ) : (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 bg-white/80 rounded-2xl p-4 flex flex-col items-center border border-gray-100 shadow-sm">
              ...
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Missions Completed</p>
            </div>
          </div>
        )}
      </div>
